    ...
    <div className='flex flex-col relative max-w-[1400px] mx-auto mt-[200px] items-center px-3'>
        ...
        <div className='mt-6 w-full max-w-[600px]'>
            ...
            <div className='bg-[#67676733] mt-6 border border-[#676767] rounded-md py-3 px-4 flex justify-center items-center gap-3 overflow-x-auto'>
                ...
                <span className='text-sm sm:text-lg'> <span className='text-brandOrange font-medium'> {`${(Number(getXreturn2().toFixed(2)).toLocaleString('en-US'))}x`} </span> my current investment of {selectedCurrency?.code || '$'}     {Number(inputField).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || 0.0} = {getProfit} </span>
            </div>
        </div>
