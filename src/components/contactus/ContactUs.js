        ...
        <div className='relative mt-40'>
            ...
            <div className='flex flex-col justify-between items-center px-4 mb-16 z-100 xl:px-32 gap-10 md:gap-5 md:flex-row sm:px-16'>
                <div className='max-w-[350px] place-items-center'>
                    <p className='text-3xl text-white text-center font-semibold max-w-[800px] w-full lg:mx-w-[800px] lg:text-[50px] lg:leading-[50px]'>Get It On The <span className='bg-gradient-to-r from-[#F3510D] to-[#F67611] bg-clip-text text-transparent'>Crypto Action</span></p>
                    ...
                    <form className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full mt-2 p-3 rounded-lg bg-[#23232E] text-white border border-[#676767] focus:outline-none focus:ring-2 focus:ring-orange-500 h-32"
                            />
                        </div>
