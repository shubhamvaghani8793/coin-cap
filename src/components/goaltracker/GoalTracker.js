...
const GoalTracker = () => {
  return (
    <>
      ...
      <div className='flex flex-col-reverse justify-between items-center gap-3 mt-5 mx-4 mb-20 md:mb-96 md:flex-row xl:mx-12'>
      <div className='max-w-[500px] md:max-w-[700px] xl:max-w-[900px] place-items-center text-center md:place-items-start md:text-start'>
        <p className='text-[24px]  font-semibold mt-5 md:mt-0 sm:text-[50px]  lg:text-[75px] xl:text-[95px]'>Track Your <span className='text-brandOrange '>Crypto Goals</span> in the App</p>
      ...
      <div className='md:h-[600px] md:min-w-[400px]'>
